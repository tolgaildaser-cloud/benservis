...
export const SEED = {
  ...
  "Fırın / Ocak / Aspiratör": [["Rezistans",300,800,500],["Termostat",250,500,450],["Fan motoru",350,900,500],["Aspiratör motoru (fan)",450,2200,600],["Aspiratör lamba / anahtar / kart",200,700,400]],
  "Klima": [["Gaz dolumu",900,2200,700],["Elektronik kart / kapasitör",150,2500,350],["Kompresör",2500,6000,2000]],
  ...
  "Televizyon / Monitör": [["Backlight LED bar",200,1500,700],["Besleme kartı",400,1500,500],["Monitör paneli",1000,6000,900],["TV paneli",3000,20000,1500],["Anakart tamiri",100,800,700],["Anakart değişimi",1500,4500,500]],
  ...
  "Bilgisayar / Yazıcı": [["Güç kaynağı / şarj soketi",50,2700,900],["Ekran kartı (GPU) / RAM / disk",1000,6000,400],["Anakart",1500,5000,1300],["Ekran paneli / menteşe (laptop)",1200,6000,850],["Kağıt besleme/merdane",100,500,500],["Yazıcı kafası temizliği",50,250,450],["Yazıcı kafası / kartuş değişimi",800,2200,500]],
};
