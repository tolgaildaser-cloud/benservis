...
export const SEED = {
  ...
  "Kurutma Makinesi": [["Rezistans / ısıtıcı grubu (kondenserli-vantilasyonlu)",300,2900,900],["Isı pompası / kompresör grubu (ısı pompalı)",10700,15500,2400],["Nem sensörü / NTC / termostat",190,400,450],["Tahliye / kondenser pompası",300,2600,600],["Kayış",300,810,700],["Tambur tekerleği / arka yatak (tekli)",75,300,900],["Tambur keçe + tekerlek takımı (komple)",600,1600,1400],["Fan pervanesi / proses-soğutma fanı",185,1100,600],["Motor grubu (tambur-fan motoru) değişimi",1800,6500,1200],["Motor kondansatörü",120,505,500],["Elektronik kart tamiri",100,600,1200],["Elektronik kart değişimi",500,3500,1300],["Kapak kilidi / mandal",85,500,400]],
};
