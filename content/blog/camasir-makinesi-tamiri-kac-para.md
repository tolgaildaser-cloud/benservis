...
- **Marka ve model:** Üstten doldurmalı, ankastre ve ithal modellerde parça daha pahalı.
...
- **Yenisini düşün:** Arıza **rulman veya kart** gibi pahalı bir kalemse, makine **10+ yaşında** ve tamir yeni bir makinenin yaklaşık **yarısını** geçiyorsa.
- **Kararsızsan:** Önce tahmini maliyeti gör; yeni makine fiyatıyla kıyasla.

## Maliyeti düşürmenin yolları

- Arızayı **erken** çözdür (su sızıntısı rulmanı, rulman kazanı vurabilir).
...
**Tamir mi yenisi mi?**
Tamir, yeni makinenin ~yarısını geçiyorsa ve makine 10+ yaşındaysa yenisi mantıklı.
