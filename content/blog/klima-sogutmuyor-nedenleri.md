...
faq:
  ...
  - q: "Klima gazı kaç yılda bir biter?"
    a: "Klima kapalı bir sistemdir; gaz normalde bitmez. Azalıyorsa bir kaçak vardır — sadece dolum yapmak geçici çözümdür, kaçağın da onarılması gerekir."
  - q: "Klimayı kendim temizleyebilir miyim?"
...
**2. Gaz azalması veya gaz kaçağı.** Klima dışarı hava üflüyor ama hava soğuk değilse, çoğu zaman soğutucu gaz seviyesi düşmüştür. Gaz "kendiliğinden bitmez" — azalıyorsa bir kaçak vardır, sadece dolum yeterli olmaz.

**3. Kirli/tıkalı dış ünite (kondenser).** Dış ünitenin önü kapalıysa ya da kanatları tozla/yaprakla dolmuşsa, sistem ısıyı dışarı atamaz ve soğutma düşer.

**4. Termostat veya sensör arızası.** Sıcaklık sensörü yanlış okursa, klima odayı yeterince soğutmadan kompresörü durdurabilir.
...
1. **Filtreyi temizle.** İç ünitenin kapağını aç, filtreleri çıkar, ılık suyla yıka, kuruyunca tak. (En sık çözüm budur.)
2. **Ayarları kontrol et.** Mod "Cool/Soğutma" olsun, sıcaklık 16–22 °C'ye çekilsin, fan hızı yükseltilsin.
3. **Dış ünitenin önünü aç.** Önünde eşya, branda veya bitki varsa kaldır; kanatlar çok tozluysa nazikçe temizle.
4. **Sigortayı/şalteri kontrol et.** Klimanın sigortası atmış olabilir.
5. **15 dakika bekle.** Yeni açılan klima tam soğutmaya zaman ister.

## Ne zaman mutlaka servis çağırmalısın?

Aşağıdakiler uzmanlık ve özel ekipman ister — kendin müdahale etme:

- Dışarı **soğuk hava hiç gelmiyorsa** (gaz/kompresör şüphesi)
- İç üniteden **su damlıyor veya buzlanma** varsa
...
Genelde gaz seviyesi düşüktür ya da kompresör/dış ünite kaynaklı bir sorun vardır. Önce filtreyi ve termostatı kontrol et; düzelmezse servis gerekir.

**Klima gazı kaç yılda bir biter?**
Klima kapalı bir sistemdir; gaz normalde "bitmez". Azalıyorsa bir kaçak vardır — sadece dolum yapmak geçici çözümdür, kaçağın da onarılması gerekir.

**Klimayı kendim temizleyebilir miyim?**
Filtreleri evet, rahatça temizleyebilirsin. Ancak gaz, elektrik ve iç mekanik aksam servis işidir.

**Soğutmayan klima elektrik faturasını yükseltir mi?**
Evet. Verimsiz çalışan klima aynı serinlik için çok daha fazla enerji harcar; sorunu erken çözmek hem konfor hem tasarruf sağlar.
