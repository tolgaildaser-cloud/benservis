...
- **Marka ve model:** Ankastre ve ithal modellerde parça ve işçilik daha pahalı.
...
- **Yenisini düşün:** Arıza **kart veya sirkülasyon pompası** gibi pahalı bir kalemse, makine **8–10+ yaşında** ve tamir yeni bir makinenin yaklaşık **yarısını** geçiyorsa.
- **Kararsızsan:** Önce tahmini maliyeti gör; yeni makine fiyatıyla kıyasla.

## Maliyeti düşürmenin yolları

- Filtreyi ve püskürtme kollarını düzenli temizle (en sık ve ücretsiz bakım).
- Tuz ve parlatıcıyı eksiltme — kireç pek çok arızayı tetikler.
- Birden çok **puanlı servisten** tahmini al; sadece yıldıza değil yorum sayısına bak.

İlgili rehberler: [Bulaşık makinesi su almıyor](/blog/bulasik-makinesi-su-almiyor/) · [Temiz yıkamıyor](/blog/bulasik-makinesi-temiz-yikamiyor/) · [Su atmıyor](/blog/bulasik-makinesi-su-atmiyor/)
...
**Keşif ücreti var mı?**
Genelde var ve iş yapılırsa toplama mahsup edilir.

**Tamir mi yenisi mi?**
Tamir, yeni makinenin ~yarısını geçiyorsa ve makine 8–10+ yaşındaysa yenisi mantıklı.
