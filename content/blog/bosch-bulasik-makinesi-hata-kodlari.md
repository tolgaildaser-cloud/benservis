...
faq:
  - q: "Bosch bulaşık makinesi E15 ne demek ve nasıl çözülür?"
    a: "E15, makinenin tabanındaki tavaya su kaçtığını ve taşma şamandırasının (flotör) güvenliği devreye soktuğunu gösterir. Geçici çözüm: makineyi ~30° yana/arkaya yatırıp taban suyunu boşaltmak ve kurulamak. Su tekrar birikiyorsa sızıntının kaynağı servisle bulunmalıdır."
...
> **E15** — Tabanda su, taşma güvenliği · genelde küçük sızıntı → 🛠️ yana yatır, suyu boşalt
>
> **E24** — Su atamıyor (tahliye) · tıkalı filtre/hortum → 🛠️ kendin
>
> **E22** — Filtre tıkalı → 🛠️ kendin

## Bosch bulaşık makinesi hata kodları (tam liste)
🛠️ = çoğu zaman kendin çözebilirsin · 🔧 = servis gerekir

| Kod | Anlamı | Ne yapmalı |
|-----|--------|------------|
| **E01 / E02** | Güç modülü / ısıtıcı kartı arızası | 🔧 Servis |
| **E09** | Isıtıcı (rezistans) arızası — su ısınmıyor | 🔧 Servis |
| **E14** | Akış sensörü / su almıyor | 🛠️ Musluğu aç, giriş filtresini kontrol et |
| **E15** | Tabanda su, taşma güvenliği (flotör) devrede | 🛠️ Yana yatır, suyu boşalt · sızıntı sürerse 🔧 |
| **E16** | Beklenmedik su alma (valf açık kalmış) | 🔧 Servis |
| **E17** | Su seviyesi yüksek (şamandıra/flotör) | 🛠️ Şamandırayı ve tüpü temizle |
| **E18** | Su seviyesi düşük / su almıyor | 🛠️ Musluk + giriş filtresi |
| **E21** | Sirkülasyon (yıkama) pompası tıkalı | 🔧 Servis |
| **E22** | İç filtre tıkalı | 🛠️ Taban filtresini çıkar, temizle |
| **E24** | Su atamıyor (tahliye filtre/hortum) | 🛠️ Filtre + tahliye hortumunu temizle |
| **E25** | Tahliye pompası tıkalı / kapağı gevşek | 🛠️ Pompa kapağını aç, yabancı cismi al |
| **E27** | Düşük voltaj (elektrik) | 🛠️ Priz/şebeke gerilimini kontrol et |
...
Tabanda su + taşma güvenliği. Makineyi yana yatırıp suyu boşalt; tekrarlarsa servis.

**E22 ve E24 farkı?**
E22 iç filtre tıkalı; E24 tahliye (filtre/hortum) sorunu. İkisi de çoğu zaman ücretsiz.

**E09 ne anlama gelir?**
Isıtıcı arızası; su ısınmaz, servis gerekir.
