---
title: "Çamaşır makinesi deterjanı almıyor, çekmecede su kalıyor: nedenleri ve çözümü"
description: "Çekmecede su ya da deterjan kalıyorsa sorun çoğu zaman su basıncı veya tıkanmış çekmecedir. Temizliği kendin yapabilirsin; giriş valfi ise servis işidir."
...
faq:
  ...
  - q: "Çekmecede her yıkamadan sonra biraz su kalması normal mi?"
    a: "Bir miktar su kalıntısı, özellikle yumuşatıcı gözünde, birçok modelde normaldir ve tasarım gereğidir. Anormal olan, gözün ağzına kadar dolu kalması, suyun günlerce durması ya da deterjanın çamurlaşıp hazneye yapışmasıdır. Normal kalıntı ile taşma noktasındaki birikinti arasındaki farkı birkaç yıkama üst üste gözleyerek anlayabilirsin."
  - q: "Toz deterjan mı sıvı deterjan mı bu sorunu daha çok yapar?"
...
Deterjanı süpürecek su zayıfsa iş baştan aksar. Musluk yarım açıksa, evde o saatlerde şebeke basıncı düşükse ya da musluk-hortum hattında bir daralma varsa çekmeceye gelen su deterjanı taşıyamaz.

**Kendin kontrol et:** Makinenin musluğunun **sonuna kadar açık** olduğundan emin ol. Evdeki diğer musluklardan suyun normal güçte akıp akmadığına bak — genel basınç düşükse sorun makinede değildir. Su giriş hortumunun makine arkasında **kıvrılmadığını, ezilmediğini** kontrol et; makine duvara fazla yaklaştırıldığında hortum bükülebilir. Bir de musluk ile hortum arasındaki küçük süzgece bak: musluğu kapatıp hortumu söktüğünde ağzında görünen bu süzgeç tortuyla tıkanmış olabilir, akan suyun altında fırçalayıp geri takabilirsin.

## 2) Çekmece ve kanalları tıkanmış — en sık sebep

Toz deterjan nemle birleşince çekmecede ve kanallarında taşlaşır; zamanla suyun geçtiği yollar daralır. Su gelir ama deterjanı söküp götüremez; göz su dolar, deterjan çamurlaşır. Yumuşatıcı gözünün emiş düzeneği de yapışkan kalıntıyla tıkanmaya çok yatkındır.

**Kendin kontrol et:** Çekmeceyi tamamen çıkar — çoğu modelde yumuşatıcı gözü hizasındaki mandala bastırarak çekilir, söküm gerektirmez. Ilık su dolu bir kapta yarım saat beklet, sonra eski bir diş fırçasıyla bütün gözleri ve kanalları fırçala; yumuşatıcı gözünün çıkarılabilir kapağı varsa onu da ayırıp altını temizle. **Yuvanın içini de ihmal etme:** el feneriyle bak, üst taraftaki su püskürtme deliklerinde kireç ve deterjan birikintisi varsa nemli bezle ve fırçayla ulaşabildiğin kadarını sil. Çekmeceyi kuruduktan sonra tak ve boş bir kısa programla dene.

⚠️ Çekmece yuvasını temizlerken makinenin kapalı olması yeterli; ama yuvaya sivri metal cisimler sokma — plastik kanalları çizip sızıntıya yol açabilirsin.

Bundan sonrası için iki küçük alışkanlık şikâyetin geri gelmesini önler: deterjanı üreticinin önerdiği miktarda kullan ve ayda bir çekmeceyi yıka. Deterjan fazlası hem tıkanmayı hızlandırır hem taşmaya yol açar — o ayrı bir dert ve su kaçağı yazısında anlatılıyor.

## 3) Doğru göz, doğru program

Küçük ama gerçek bir ihtimal: deterjan **yanlış göze** konuyor olabilir. Çoğu çekmecede ana yıkama, ön yıkama ve yumuşatıcı gözleri ayrıdır ve makine her göze yalnız ilgili adımda su verir. Ön yıkama gözüne konan deterjan, ön yıkamasız bir programda hiç ıslanmadan kalır.

**Kendin kontrol et:** Kullanım kılavuzundan ya da çekmece üzerindeki simgelerden hangi gözün ana yıkama olduğunu doğrula. Seçtiğin programın deterjanı koyduğun gözü gerçekten kullandığından emin ol. Tablet ya da kapsül kullanıyorsan üreticisi çekmeceye değil doğrudan tambura konmasını öneriyor olabilir — ambalajına bak.

## 4) Giriş valfi ve dağıtım düzeneği — burada durman gereken yer

Musluk açık, basınç iyi, süzgeç ve çekmece tertemiz, göz doğru — deterjan hâlâ yerinde kalıyorsa şüphe makinenin içine döner. Su giriş valfi birden fazla gözlüdür; hangi bölmeye su gideceğini bu valf ve üstteki dağıtım düzeneği belirler. Valfin bir gözü zayıflamışsa ya da dağıtım kanalları içeriden kireçlendiyse su yanlış yere veya yetersiz gider.

Bunun tipik işareti şudur: makine su alıyor, yıkıyor, ama **belirli bir göz** ısrarla dolu ya da deterjanlı kalıyor.

⛔ **Kendin-çöz sınırı burada biter.** Valf ve dağıtım düzeneği gövdenin içindedir; hem su hem elektrik bağlantısıyla çalışır. Buranın teşhisi ve değişimi servis işidir — kullanıcının yapacağı en doğru şey, hangi gözün dolu kaldığını ve temizlik denemelerini servise net aktarmaktır.

## Belirti tablosu

| Belirti | Muhtemel sebep | Kendin bakılır mı |
|---|---|---|
| Bütün gözlerde deterjan/su kalıyor, su zayıf geliyor | Basınç, musluk, bükülmüş hortum, tıkalı süzgeç | ✅ Evet |
| Deterjan çamurlaşıyor, kanallar taşlı | Çekmece ve yuva tıkanıklığı | ✅ Evet |
| Yalnız ön yıkama gözü hiç boşalmıyor | Yanlış göz / programsız göz | ✅ Evet |
| Yumuşatıcı gözü hep ağzına kadar dolu | Emiş düzeneği kirli | ✅ Evet, çekmece temizliğiyle |
| Temizliğe rağmen aynı göz ısrarla dolu | Giriş valfi / dağıtım düzeneği | ⛔ Servis |
| Makine hiç su almıyor | Ayrı konu — su alma hattı | ⚠️ Kendi yazısına bak |

## Servis çağırmadan önce üç dakika

1. **Musluğu sonuna kadar aç**, hortumun ezilmediğine ve süzgecin temiz olduğuna bak.
2. **Çekmeceyi çıkar, ılık suda beklet, fırçala** — yuvanın üst deliklerini de sil.
3. **Doğru göz–doğru program** eşleşmesini kılavuzdan doğrula, boş kısa programla dene.

Bu üçü şikâyetin büyük kısmını yerinde çözer. Çözmediyse elinde servise anlatacağın somut bir tablo olur: hangi göz dolu kalıyor, su ne güçte geliyor, temizlik neyi değiştirdi. Doğru tarif, doğru parçayla gelinmesini sağlar.
