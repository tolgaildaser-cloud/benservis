...
- **Marka ve model:** Ankastre, gardırop tipi (side-by-side) ve ithal modellerde parça daha pahalı.
...
- **Tamir et:** Arıza conta, termostat, fan, defrost gibi **orta-düşük maliyetli** bir kalemse ve cihaz 10 yaşından gençse.
- **Yenisini düşün:** Arıza **kompresör/gaz** gibi pahalı bir kalemse, cihaz **10+ yaşında** ve tamir maliyeti yeni bir dolabın yaklaşık **yarısını** geçiyorsa.
- **Kararsızsan:** Önce tahmini maliyeti gör; rakamı yeni cihaz fiyatıyla kıyasla.

## Maliyeti düşürmenin yolları

- Arızayı **erken** çözdür (küçük sorun büyümeden).
- Düzenli kontrol ile conta/defrost arızalarını önle.
- Birden çok **puanlı servisten** tahmini al; sadece yıldıza değil yorum sayısına bak.

İlgili rehberler: [Buzdolabı soğutmuyor ama çalışıyor](/blog/buzdolabi-sogutmuyor-nedenleri/) · [No-frost alt bölme soğutmuyor](/blog/no-frost-buzdolabi-alt-bolme-sogutmuyor/) · [Buzdolabı ses yapıyor](/blog/buzdolabi-ses-yapiyor/)
...
**Tamir mi yenisi mi?**
Tamir, yeni cihazın ~yarısını geçiyorsa ve cihaz 10+ yaşındaysa yenisi mantıklı.
