...
faq:
  - q: "En sık çıkan bulaşık makinesi hata kodu hangisi?"
    a: "Bosch/Siemens'te E15 (tabanda su / taşma güvenliği) ve E24 (tahliye) en sıktır. E15 çoğu zaman makineyi hafif yana yatırıp taban suyunu boşaltınca geçici olarak sıfırlanır, ama sızıntının kaynağı bulunmalıdır."
...
|-----|--------|------------|
| E15 | Tabanda su, taşma güvenliği devrede | Makineyi ~30° yana yatır, taban suyunu boşalt; sızıntı kaynağını servisle bul |
...
|-----|--------|------------|
| Su alma hatası (örn. H5) | Makine su alamıyor | Musluğu aç, giriş filtresi/hortumu kontrol et |
...
3. **E15'te:** makineyi hafif yana yatır, taban suyunu boşalt, kurula. (Sızıntı tekrarlarsa servis.)
