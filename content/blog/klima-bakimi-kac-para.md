...
- Çok yoğun kullanım, tozlu ya da kıyı ortamında **yılda 2 kez**.
- Filtre temizliği daha sık (2-3 haftada bir kendin yapabilirsin).

## Bakımda neler yapılır?

- **Filtre temizliği** (iç ünite)
- **İç ünite** evaporatör ve fan temizliği
- **Dış ünite** kondenser temizliği
- **Gaz/basınç kontrolü** (eksikse uyarı — dolum ayrı işlemdir)
- **Drenaj hattı** (su tahliye) temizliği — damlamayı önler
- **Elektrik bağlantısı** kontrolü

## Bakım atlanırsa ne olur?

- **Soğutma düşer**, aynı serinlik için daha çok çalışır → **fatura artar**
- Kirli ünitede **küf, bakteri ve koku** → sağlıksız hava
...
Verim düşer, fatura artar, koku/küf oluşur, arıza riski ve ömür kaybı.
