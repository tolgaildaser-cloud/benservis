...
> 🚨 **Bosch'un bu kodda verdiği talimat net:** *"Sağlığınız ve güvenliğiniz için sorunu evde tek başınıza çözmeyi denememenizi öneririz. Şebeke suyunu kesin ve cihazı kapatın."*
>
...
Bosch bulaşık makinelerinin tabanında bir **su toplama tavası** ve içinde bir **şamandıra (flotör) şalteri** bulunur. Makinenin herhangi bir yerinden su sızarsa bu tavada birikir; şamandıra yükselir ve güvenlik devresi makineyi durdurur. İşte bu durumun ekrandaki adı **E15**'tir. Bosch bu koruma sistemine **AquaStop** ailesinde yer verir — amacı, mutfağını su basmasını engellemek.

Yani E15 aslında makinenin "bozuldum" demesi değil, **"içimde olmaması gereken yerde su var, evini korumak için durdum"** demesidir.

## Suyun tabana kaçmasının sık sebepleri

- **Tek seferlik taşma veya aşırı köpük** — yanlış/fazla deterjan, elde bulaşık deterjanı kullanımı. En masum senaryo.
- **Kapı contası yıpranması** — kapak kenarından sızan su tabana iner.
- **Hortum veya bağlantı sızıntısı** — giriş/tahliye hortumu gevşemiş ya da çatlamış olabilir.
...
Suyu boşalttın, kuruttun ama makine kısa sürede yine E15 veriyorsa **içeride aktif bir sızıntı** var: conta, hortum, valf veya pompa kaynaklı olabilir. Bu noktada kaynağı bulmak servis işidir; sızıntıyı görmezden gelip suyu tekrar tekrar boşaltmak hem zemine hem makineye zarar verir.

Maliyet açısından iyi haber: E15'in arkasından çıkan işlerin çoğu (conta, hortum, valf) **düşük-orta maliyetli** tamirlerdir; makineyi emekli etmeyi gerektirmez. Detaylı fiyat aralıkları için: [bulaşık makinesi tamiri kaç para?](/blog/bulasik-makinesi-tamiri-kac-para/)

## Servise gitmeden önce: tahmini öğren

[Benservis'e](/) "Bosch bulaşık makinesi E15 veriyor, suyu boşalttım yine geldi" gibi belirtini yaz; yapay zeka olası kaynağı ve **tahmini tamir maliyetini ücretsiz** söylesin. Servisle konuşurken elinde bir kıyas noktası olur — önce öğren, sonra çağır.

İlgili rehberler: [Bosch bulaşık makinesi hata kodları (tam liste)](/blog/bosch-bulasik-makinesi-hata-kodlari/) · [Bulaşık makinesi su almıyor](/blog/bulasik-makinesi-su-almiyor/) · [Bulaşık makinesi su atmıyor](/blog/bulasik-makinesi-su-atmiyor/) · [Bulaşık makinesi hata kodları (marka marka)](/blog/bulasik-makinesi-hata-kodlari/)
...
**Tamiri kaç para?**
Tek seferlik taşmada ücretsiz. Sızıntıda kaynağa göre değişir (conta/hortum/valf = genelde düşük-orta maliyet) — tahmini Benservis'ten öğren.

**Siemens/Profilo'da da aynı mı?**
Evet, BSH platformu ortak: E15 hepsinde aynı anlam ve çözüm.
