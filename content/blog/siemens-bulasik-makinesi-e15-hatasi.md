...
guide:
  ...
  totalTime: "PT25M"
  cost: "Ücretsiz"
  tools: ["Havlu / paspas", "Sünger ve sığ bir kap", "Yardım edecek bir kişi (makineyi eğmek için)"]
steps:
  - "Makineyi kapat, fişini çek ve su musluğunu kapat."
  - "Alt sepeti çıkar, içerideki filtre bölgesinde su varsa süngerle al."
  - "Makinenin önüne ve altına havlu ser."
  - "Ankastre ise makineyi yuvasından biraz öne çek."
  - "Bir kişinin yardımıyla makineyi öne doğru yaklaşık 30-45° eğ; taban tavasındaki su alttan boşalacak."
  - "Su gelmesi kesilene kadar eğik tut, sonra yavaşça yerine bırak."
  - "Tabanın kuruması için makineyi mümkünse birkaç saat beklet."
  - "Fişi tak, musluğu aç ve kısa bir programla dene; hata tekrar gelirse servisi ara."
faq:
...
> ⚡ **Kısa özet:** E15 = taban tavasına su kaçmış, şamandıralı taşma güvenliği (AquaStop) makineyi durdurmuş. Çözüm: fişi çek → musluğu kapat → makineyi ~30-45° öne eğip taban suyunu boşalt → kurut → kısa programla dene. Kısa sürede tekrar ederse içeride sızıntı vardır → servis.
...
Makine doluyken ağırdır; eğme adımı için bir yardımcıya ihtiyacın olacak.

**1. Güvenliği al.** Makineyi kapat, **fişini çek**, **su musluğunu kapat**. Elektrik ve su aynı anda açıkken bu işe başlama.

**2. İçini hafiflet.** Alt sepeti çıkar. Yıkama bölmesinin tabanındaki filtre çukurunda su birikmişse süngerle alıp kaba boşalt — hem makine hafifler hem eğerken daha az su taşar.

**3. Zemini hazırla.** Makinenin önüne ve altına havlu ya da paspas ser.

**4. Öne çek.** Ankastre modelde makineyi yuvasından birkaç santim öne çekmen gerekebilir; hortumları zorlamadan, yavaş çek.

**5. Eğ ve boşalt.** Bir kişinin yardımıyla makineyi **öne doğru yaklaşık 30-45°** eğ. Taban tavasındaki su alttan boşalacak — bu tamamen normal, planladığımız şey de bu.

**6. Bekle, sonra bırak.** Su gelişi kesilene kadar eğik tut; sonra makineyi yavaşça yerine bırak.

**7. Kurut.** Tabanın tam kuruması için mümkünse birkaç saat beklet. Aceleyle denersen nemli şamandıra "hayalet" E15 verdirebilir.

**8. Dene.** Fişi tak, musluğu aç, **kısa bir program** başlat. Kod gelmiyorsa sorun büyük ihtimalle tek seferlik taşma ya da köpüktü.

⚠️ **Sınırını bil:** Alt paneli sökmek, şamandıraya, pompaya ya da valfe elle müdahale etmek elektrikli-sulu bir bölgede çalışmak demektir ve **servis işidir**. Eğme, boşaltma ve kurutma senin güvenli alanın; kapak ve panel seviyesi kullanıcıya, tablanın altı servise aittir.
