---
title: "Beko çamaşır makinesi E10 hatası: su alamıyor — adım adım çözüm"
description: "Beko çamaşır makinesi E10 hatası su alamama demek. Musluk, hortum ve giriş süzgeci kontrolüyle çoğu zaman evde çözülür; adım adım yol ve servis sınırı burada."
...
faq:
  - q: "Beko çamaşır makinesi E10 hatası ne demek?"
    a: "E10, makinenin su alma aşamasında beklenen süre içinde hedef su seviyesine ulaşamadığını gösterir. Yani makine 'su istedim ama gelmedi ya da çok yavaş geldi' diyor. Sebep çoğu zaman makinenin dışındadır: kapalı ya da kısık musluk, su kesintisi, bükülmüş hortum veya tıkanmış giriş süzgeci. Sebep içerideyse su giriş valfi veya seviye ölçümü tarafındadır."
  - q: "E10 hatası fişten çekince geçer mi?"
  ...
  - q: "Musluk açık, su var ama makine yine E10 veriyor — neden?"
...
> ⚡ **Kısa özet:** E10 = su alma zaman aşımı. Sıra şu: musluk ve su kesintisi → hortumda bükülme → hortum girişindeki süzgecin temizliği → resetleyip kısa programla deneme. Hepsi temizse ve hata tekrarlıyorsa sorun valf/sensör tarafındadır → servis.

## E10 ne anlatıyor?

Makine su almaya başladığında içerideki seviye ölçümü sürekli izlenir. Belirlenen süre dolduğunda hedef seviyeye ulaşılamamışsa program güvenli şekilde durdurulur ve E10 gösterilir. Yani bu kod "bir parça yandı" demek değildir; "su bana ulaşmıyor" demektir. Bu ayrım önemli, çünkü suyun ulaşmama sebeplerinin çoğu ücretsiz ve beş dakikalık kontrollerle bulunur.

Bir uyarı: Beko farklı serilerde farklı kod şemaları kullanır. Yaygın serilerde E10 su alma hatasıdır; yine de kendi makinenin kılavuzundan teyit etmek her zaman en sağlamıdır.

## Adım adım: evde denenecekler

**1. Güvenliği al.** Programı iptal et, makineyi kapat ve **fişini çek**. Su ve elektrikle aynı anda uğraşma.

**2. Musluğu kontrol et.** Makinenin arkasındaki su musluğu tam açık mı? Temizlik ya da tadilat sonrası kısılmış olabilir. Aynı anda evde su olup olmadığına da bak — mahalle kesintisi, E10'un en masum sebebidir.
...
Beko çamaşır makinesi hata kodları yazımızda E ve H kodlarının tam listesi ve her birinde ne yapman gerektiği var. Cihazının belirtisine göre tahmini maliyeti görmek ve yakınındaki puanlı servisleri listelemek için benservis.com'daki ücretsiz teşhisi kullanabilirsin. Bil, gör, çağır.
