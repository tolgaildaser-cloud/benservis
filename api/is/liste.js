...
export default async function handler(req, res) {
  ...
  const { data: isler, error } = await supabase
    .from("is_talepleri")
    .select("id, is_no, servis_id, servis_ad, musteri_ad, adres, tarih_tercihi, cihaz, belirti, durum, son_kabul_tarihi, gelis_penceresi, twilio_numara, seri_no, puan, yorum, created_at")
