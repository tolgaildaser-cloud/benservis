...
### Faz 5 — Perakende Entegrasyonu + Garanti Takibi  🔮 VİZYON
Müşteri Teknosa / Koçtaş / Hepsiburada gibi platformlardan ürün satın aldığında,
DPP kaydı **otomatik olarak** müşterinin envanterine düşer (perakende API entegrasyonu).
Manuel giriş alternatifi her zaman var.

Aynı faz garanti süresini de takip eder:
- Satın alma tarihi + garanti süresi → uyarı (garanti dolmadan önce bildirim)
- Garanti kapsamındaki tamirler DPP'de "garanti tamiri" olarak işaretlenir
- Garanti bitmeden satış: alıcı kalan süreyi DPP'den görür

**Entegrasyon hedefleri:** Teknosa, Koçtaş, Hepsiburada, Trendyol, Amazon TR
